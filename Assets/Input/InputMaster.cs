...
public class @InputMaster : IInputActionCollection, IDisposable
{
    ...
    public struct PlayerGraphicAdventureActions
    {
        ...
        public PlayerGraphicAdventureActions(@InputMaster wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @InputMaster m_Wrapper;
        public PlayerDemolitionRaceActions(@InputMaster wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @InputMaster m_Wrapper;
        public BackpackActions(@InputMaster wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @InputMaster m_Wrapper;
        public MenúActions(@InputMaster wrapper) { m_Wrapper = wrapper; }
